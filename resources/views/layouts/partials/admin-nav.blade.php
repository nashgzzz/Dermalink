    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="text-sm negro dark:text-gray-500 hover:underline"> {{ __('Login') }}</a>


                            <a href="{{ route('register') }}" class="ml-4 text-sm negro dark:text-gray-500 hover:underline"> {{ __('Register') }}</a>

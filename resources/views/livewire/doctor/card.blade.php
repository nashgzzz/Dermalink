...
<div class="bg-white p-3 border-t-4 border-blue-600">
                        <div class="image overflow-hidden">
                            @if ($doctor->user->avatar)
                                ...
                                src="{{ Storage::url($doctor->user->avatar) }}"
                                alt="">
                            @else
                                @can('edit-doctor')
                                    <a wire:click="changeAvatar" class="absolute mb-10 mr-10 rounded-full bg-yellow-300 p-2 text-white cursor-pointer">
    ...
    {{--                     <p class="text-sm text-gray-500 hover:text-gray-600 leading-6">Lorem ipsum dolor sit amet
                        ...
                        <ul
                            ...
                            <li class="flex items-center py-3">
                                ...
                                @can('edit-doctor')
                                    @if ($doctor->state == 0)
                                        <span class="ml-auto" wire:click="changeState"><span class="bg-red-500 py-1 px-2 rounded text-white text-sm">Inactivo</span></span>
                                    @else
                                        <span class="ml-auto" wire:click="changeState"><span class="bg-green-500 py-1 px-2 rounded text-white text-sm">Activo</span></span>
                                    @endif
                                @else
                                @if ($doctor->state == 0)
